...
public class PendingSongActivity extends AppCompatActivity {
    ...
    {
        if (user != null) {
            CollectionReference collectionReference = firestore.collection(FIRESTORE_SONG_PENDING_PATH);
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        else
                        {
                            ...
                            tvNoResult.setText("אין שירים הממתינים לאישור");
                        }
                    } else {
